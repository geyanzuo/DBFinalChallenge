...
GO
:setvar DatabaseName "DBmodel"
:setvar DefaultFilePrefix "DBmodel"
:setvar DefaultDataPath "C:\Users\102146016\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB"
:setvar DefaultLogPath "C:\Users\102146016\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB"
...
GO
PRINT N'Creating [dbo].[Customers102146016]...';


GO
CREATE TABLE [dbo].[Customers102146016] (
    [CustomerNo]      INT            NOT NULL,
    [CustomerName]    NVARCHAR (50)  NULL,
    [CustomerAddress] NVARCHAR (200) NULL,
    [CustomerPcode]   INT            NULL,
    PRIMARY KEY CLUSTERED ([CustomerNo] ASC)
);


GO
PRINT N'Creating [dbo].[Interests102146016]...';


GO
CREATE TABLE [dbo].[Interests102146016] (
    [InterestCode] VARCHAR (2)    NOT NULL,
    [CustomerNo]   INT            NOT NULL,
    [InterestDesc] NVARCHAR (100) NULL,
    PRIMARY KEY CLUSTERED ([InterestCode] ASC, [CustomerNo] ASC)
);


GO
PRINT N'Creating [dbo].[Orders102146016]...';


GO
CREATE TABLE [dbo].[Orders102146016] (
    [CustomerNo] INT           NOT NULL,
...
GO
PRINT N'Creating [dbo].[Perform102146016]...';


GO
CREATE TABLE [dbo].[Perform102146016] (
    [RecordID]  VARCHAR (20)  NOT NULL,
...
GO
PRINT N'Creating unnamed constraint on [dbo].[Interests102146016]...';


GO
ALTER TABLE [dbo].[Interests102146016]
...
GO
ALTER TABLE [dbo].[Orders102146016]
    ADD FOREIGN KEY ([CustomerNo]) REFERENCES [dbo].[Customers102146016] ([CustomerNo]);
